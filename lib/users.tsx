...
export const USERS: Record<string, UserProfile> = {
  ...
  alessia: {
    ...
    profile: {
      ...
      answerTrail: [
        { day: 'Today', song: 'Brooklyn Baby', artist: 'Lana Del Rey', today: true },
        { day: 'Sun', song: 'Move', artist: 'Adam Port' },
        { day: 'Sat', song: 'Space Song', artist: 'Beach House' },
        { day: 'Fri', song: 'Call Out My Name', artist: 'The Weeknd' },
        { day: 'Thu', song: 'It Goes Like (Nanana)', artist: 'Peggy Gou' },
        { day: 'Wed', song: 'Latch', artist: 'Disclosure' },
        { day: 'Tue', song: 'Baby Girl', artist: 'Disco Lines' },
      ],
      playlistTracks: [
  ...
  sofia: {
    ...
    profile: {
      ...
      answerTrail: [
        { day: 'Today', song: 'Right Side of My Neck', artist: 'Faye Webster', today: true },
        { day: 'Sun', song: 'Bags', artist: 'Clairo' },
        { day: 'Sat', song: 'Motion Sickness', artist: 'Phoebe Bridgers' },
        { day: 'Fri', song: 'Good Days', artist: 'SZA' },
        { day: 'Thu', song: 'Self Control', artist: 'Frank Ocean' },
        { day: 'Wed', song: 'Bad Habit', artist: 'Steve Lacy' },
        { day: 'Tue', song: 'Space Song', artist: 'Beach House' },
      ],
      playlistTracks: [
