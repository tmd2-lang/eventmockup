...
export const GPB_SEED_EVENTS: EventItem[] = [
  ...
  {
    id: 'gpb-finals-destress',
    day: 'Tuesday, December 8, 2026',
    time: '7:00 PM – 10:00 PM',
    endTime: '10:00 PM',
    name: 'Finals Week De-Stress Night',
    host: 'Georgetown Program Board',
    hostName: 'Georgetown Program Board',
    hostOrganizationId: 'program_board',
    hostAvatar: 'GPB',
    hostAvatarColor: '#0050ff',
    venue: 'Leavey Esplanade',
    description: 'Free snacks, games, and wind-down programming on Leavey Esplanade during finals week. Planning stage.',
    category: 'campus',
    color: '#0050ff',
    visibility: 'campus',
    eligibleCampuses: ['georgetown'],
